            ...
            <form action="../controller/controller.php" style=" width: 100%;">
                ...
                <table  align="center"  style=" width: 100%; background-color: #cccccc; display: block">                                                                                    
                    ...
                    <tr>
                        ...
                        <td><br><input  pattern="[A-Za-z ]+" type="password" name="passwordlogin" required="true"></br></td>
                        <td width="450"></td>
                    </tr>
                    <tr>
                        <td width="450"></td>
                    ...
                    <tr>
                        <td width="450"></td>
                        <td colspan="4"><center><input style="background-color: #006633; font-size: medium;border-radius: 0 50% / 0 100%;" type="submit" value="CAMBIAR CONTRASEÑA" class="btn btn-sm" ></center></td>
                    <td width="450"></td>
                    </tr>
                </table>
            </form>
