			...
			<div class="border"></div>
                        ...
                        if (isset($_SESSION['listaUsuarios'])) {
                            ...
                            foreach ($listado as $usu) {
                                ...
                                echo "<td><button><a style=''; href='../controller/controller.php?opcion=eliminar_usuario&idusuario=" . $usu->getIdusuario() . "'></a><span class='glyphicon glyphicon-pencil' > Eliminar </span></button></td>";
                                echo "<td><button><a style=''; href='../controller/controller.php?opcion=editar_usuario&idusuario=" . $usu->getIdusuario() . "'></a><span class='glyphicon glyphicon-pencil' > Editar </span></button></td>";                                
                                echo "</tr>";
                            }
