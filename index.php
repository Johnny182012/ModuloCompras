            ...
            <div id="slitSlider" class="sl-slider-wrapper">
				<div class="sl-slider">
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						...
						<div class="carousel-caption">
							<div>
								...
								<h2 data-wow-duration="500ms"  data-wow-delay="500ms" class="heading animated fadeInRight">AL MÓDULO COMPRAS</h2>
							</div>
						</div>
						</div>
					</div>
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
						...
						<div class="carousel-caption">
							<div>
								<h2 class="heading animated fadeInRight">Una página profesional</h2>
            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="Navigation">
                    <ul id="nav" class="nav navbar-nav">
                        ...
                        <li><a href="#showcase">Proveedores</a></li>
					...
					<div class="col-lg-12">
						...
						<div class="portfolio-filter clearfix">
							<ul class="text-center">
							    <li><a href="../controller/controller.php?opcion=crear_proveedor" class="filter" >Ingresar Proveedor</a></li>
                                                            <a class="btn btn-primary" href="../controller/controller.php?opcion=listar_proveedores">PROVEEDORES</a>
								<li><a href="../pedidos.php" class="filter" data-filter=".app">Listar Proveedores</a></li>
								<li><a href="javascript:void(0)" class="filter" data-filter=".web">Reporte</a></li>
